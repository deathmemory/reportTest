/************************************************************************/
/* 主要功能: Base64 加密变种 和 MD5 加密集合
/* 思路: 换汤不换药的, 算法一定是相同的, 只是把基字串修改了
/* 作者: 解云飞
/* 日期: 2012/03/02			最后修改日期: 2012/03/07
/************************************************************************/
#pragma once
...
class CCodeHelper : public CDMBase64
{
public:
	CCodeHelper(void);
	virtual ~CCodeHelper(void);
};
